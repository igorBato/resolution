...
<?php
		echo do_shortcode('[ajax_load_more id="loadmore" posts_per_page="4" loading_style="grey" container_type="div"  category="'.$category[0]->slug.'" post__not_in="'.$post_id.'" css_classes="articles" post_type="post" pause="true" scroll="false" button_label="More articles >"]');
	?>
